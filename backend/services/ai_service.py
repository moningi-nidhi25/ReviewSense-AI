...
def analyze_review(guest_name: str, review_text: str) -> dict:
    ...
    if settings.GEMINI_API_KEY:
        try:
            ...
            prompt = f"""
You are an AI assistant for ReviewSense AI (Trishul Eco-Homestays Network).
...
{{
  ...
  "ai_response": "A polite, personalized 2-sentence reply from homestay management addressing {guest_name}."
}}
"""
    ...
    if sentiment == "Positive":
        resp = f"Dear {guest_name}, thank you so much for your kind review! We are delighted that you had a wonderful stay with us at Trishul Eco-Homestays and hope to welcome you back soon."
    elif sentiment == "Negative":
        resp = f"Dear {guest_name}, thank you for sharing your feedback. We sincerely apologize for the inconveniences during your stay and are taking immediate measures to improve."
    else:
        resp = f"Dear {guest_name}, thank you for reviewing your stay with us. We appreciate your feedback and look forward to offering you an even better experience next time!"
